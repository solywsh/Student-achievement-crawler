...
cookie = {
    ...
    # 注意，如果直接以'JSESSIONID=XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX'形式传入students_summary_table(_cookie,databsae_info)
    # 而不传入semester.id，那么将会爬取数据库所有学生的信息
    'semester.id': 122,
    'JSESSIONID': '6C22190EC16C125DA3407D9E0ADF88B8.-node1'
}
...
if __name__ == '__main__':
    ...
    # # 学生详细列表
    xsyu_detailed(_cookie, databsae_info)
